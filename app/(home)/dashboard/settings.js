...
export default function Settings() {
  ...
  const settingsOptions = [
    { icon: 'user', label: 'Account', color: '#3498db', action: () => navigation.navigate('AccountSettings') },
    { icon: 'bell', label: 'Notifications', color: '#f39c12', action: () => navigation.navigate('NotificationSettings') },
